    ...
    public class LiveSensorFactory
    {
        ...
        private IEnumerable<SensorProperties> BuildTestProperties()
        {
            return new SensorProperties[]
            {
                ...
                new SensorProperties("Engine_Heat", new RequirementRange(0, 300), new RequirementRange(73230, 132350), new RequirementRange(1500000, 1500001), "When wind_speed is over 176 for 3 seconds")
            };
        }
